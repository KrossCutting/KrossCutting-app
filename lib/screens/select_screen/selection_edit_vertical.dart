...
class SelectionVertical extends StatefulWidget {
  const SelectionVertical({super.key});

  @override
  State<SelectionVertical> createState() => _SelectionVerticalState();
}

class _SelectionVerticalState extends State<SelectionVertical> {
  ...
  Future<void> _initPlayer() async {
    _videoPlayerController =
        VideoPlayerController.asset("assets/aespaVertical_One.mp4");
                        ...
                        children: [
                          buildOverlapGradientIconButton(
                            ...
                            onPressed: () {
                              ...
                              // TODO: 갤러리로 돌아갈시 사용자가 선택한 영상 기록이 남아있고, 영상을 재선택할 수 있도록 개선합니다.
                            },
                          ),
                          GradientText(
