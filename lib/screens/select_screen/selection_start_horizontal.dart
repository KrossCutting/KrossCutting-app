...
class SelectionStartHorizontal extends StatefulWidget {
  const SelectionStartHorizontal({super.key});

  @override
  State<SelectionStartHorizontal> createState() =>
      _SelectionStartHorizontalState();
}

class _SelectionStartHorizontalState extends State<SelectionStartHorizontal> {
            ...
            children: [
              ...
              buildGradientIconButton(
                ...
                onPressed: () {
                  ...
                  // TODO. restore 아이콘 클릭시 선택했던 모든 편집점을 삭제합니다.
                  // TODO. 따라서 전역상태인 currentVideoPosition들을 모두 삭제합니다.
                },
              ),
            ],
          )
